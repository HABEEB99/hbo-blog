...
const Footer: React.FC<FooterProps> = () => {
	return (
		<footer className="flex h-[4vh]  bg-bgDark dark:bg-bgLight shadow-xl w-screen items-center justify-center space-x-4 bg-header px-3 sm:px-5 md:px-12 lg:px-32">
			<span className="text-xs md:text-md lg:text-lg text-gray-200 dark:text-gray-500">
